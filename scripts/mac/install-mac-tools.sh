...
install -m 0755 "$ROOT/scripts/mac/win-codex-reset-home" "$BIN/win-codex-reset-home"
install -m 0755 "$ROOT/scripts/mac/win-codex-migrate-sessions" "$BIN/win-codex-migrate-sessions"
install -m 0755 "$ROOT/scripts/mac/win-reboot-report" "$BIN/win-reboot-report"
...
echo "  $BIN/win-ssh"
echo "  $BIN/win-codex"
echo "  $BIN/win-codex-reset-home"
echo "  $BIN/win-codex-migrate-sessions"
echo "  $BIN/win-reboot-report"
